...
def main(page: ft.Page):
    ...
    def article1_info(event):
        ...
        info_article1 = ft.Text(value="Игорь линк", size=25, weight=ft.FontWeight.BOLD,italic=True, color=ft.colors.BLACK87)
        
        info_article2 = ft.Text(value="Текст", color=ft.colors.BLACK87)
        ...
        cont_info_art1 = ft.Container (
            ...
            margin=5,
            bgcolor=ft.colors.BLUE_50,
            content=ft.Column([article1, info_article1, info_article2])
        )
        
        page.add(cont_info_art1)
    ...
    def article2_info(event):
        ...
        info_article3 = ft.Text(value="DeadP47", size=25, weight=ft.FontWeight.BOLD,italic=True, color=ft.colors.BLACK87)
        
        info_article4 = ft.Text(value="кушает чокопай", color=ft.colors.BLACK87)
        ...
        cont_info_art2 = ft.Container (
            ...
            margin=5,
            bgcolor=ft.colors.BLUE_50,
            content=ft.Column([article2, info_article3, info_article4])
        )
        
        page.add(cont_info_art2)
    ...
    def quizes1_info(event):
        ...
        info_quizes1 = ft.Text(value="Игорь линк", size=25, weight=ft.FontWeight.BOLD,italic=True, color=ft.colors.BLACK87)
        
        info_quizes2 = ft.Text(value="текст", color=ft.colors.BLACK87)
        
        cont_info_quizes1 = ft.Container (
            width=260,
            height=240,
            border_radius=15,
            padding=5,
            margin=5,
            bgcolor=ft.colors.BLUE_50,
            content=ft.Column([quizes1, info_quizes1, info_quizes2])
        )
        
        page.add(cont_info_quizes1)
    ...
    def quizes2_info(event):
        ...
        info_quizes3 = ft.Text(value="DeadP47", size=25, weight=ft.FontWeight.BOLD,italic=True, color=ft.colors.BLACK87)
        
        info_quizes4 = ft.Text(value="текст", color=ft.colors.BLACK87)
        
        cont_info_quizes2 = ft.Container (
            width=260,
            height=240,
            border_radius=15,
            padding=5,
            margin=5,
            bgcolor=ft.colors.BLUE_50,
            content=ft.Column([quizes2, info_quizes3, info_quizes4])
        )
        
        page.add(cont_info_quizes2)
    ...
    def my_task1_info(event):
        ...
        info_task1 = ft.Text(value="Игорь линк", size=25, weight=ft.FontWeight.BOLD,italic=True, color=ft.colors.BLACK87)
        
        info_task2 = ft.Text(value="Выборы 2024", color=ft.colors.BLACK87)
        
        cont_info_task1 = ft.Container (
            width=260,
            height=240,
            border_radius=15,
            padding=5,
            margin=5,
            bgcolor=ft.colors.BLUE_50,
            content=ft.Column([my_task1, info_task1, info_task2])
        )
        
        page.add(cont_info_task1)
    ...
    def my_task2_info(event):
        ...
        info_task3 = ft.Text(value="DeadP47", size=25, weight=ft.FontWeight.BOLD,italic=True, color=ft.colors.BLACK87)
        
        info_task4 = ft.Text(value="офигевает", color=ft.colors.BLACK87)
        
        
        cont_info_task2 = ft.Container (
            width=260,
            height=240,
            border_radius=15,
            padding=5,
            margin=5,
            bgcolor=ft.colors.BLUE_50,
            content=ft.Column([my_task2, info_task3, info_task4])
        )
        
        page.add(cont_info_task2)
